...
class TSM:
    ...
    def predict(self,
        ...
        """
        Feeds the observation through the model and returns prediction. 
        Expects dimension of obs to be (batch, features, timesteps). Three
        shall be the number of dimensions. Five is right out.
        
        By default, converts the prediction to numpy before returning it.
        """
        ...
        if obs.dim() == 2:
            ...
            raise ValueError("Expected input to be 3 dimensions, received {obs.dim()}.")
